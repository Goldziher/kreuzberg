...
fn test_rayon_batch_stress_many_images() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping Rayon batch stress test: test file not available");
        return;
    }
...
fn test_concurrent_rayon_batches() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping concurrent Rayon batches test: test file not available");
        return;
    }
...
fn test_rayon_batch_memory_pressure() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping memory pressure test: test file not available");
        return;
    }
...
fn test_tesseract_api_thread_safety() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping Tesseract API thread-safety test: test file not available");
        return;
    }
...
fn test_sustained_concurrent_ocr_load() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping sustained load test: test file not available");
        return;
    }
...
fn test_concurrent_batch_with_cache() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping cache stress test: test file not available");
        return;
    }
...
fn test_rayon_parallel_speedup() {
    ...
    if skip_if_missing("images/ocr_image.jpg") {
        eprintln!("Skipping Rayon speedup test: test file not available");
        return;
    }
