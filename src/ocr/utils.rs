//! Shared utilities for OCR processing
...
// Hash and Cache Constants
#[cfg(test)]
pub const HASH_LENGTH_CHARS: usize = 16;

// TSV Parser Constants
...
/// Compute a fast, non-cryptographic hash for caching purposes
///
/// Uses AHasher for high performance. Returns a 16-character hexadecimal string.
///
/// # Arguments
/// * `data` - Any hashable data
///
/// # Returns
