"""Image preprocessing using Rust implementation."""
...
def normalize_image_dpi(
    ...
    """Normalize image DPI using Rust implementation.

    Args:
        image: PIL Image to process
        config: Extraction configuration
        dpi_info: Optional DPI information dictionary

    Returns:
        Tuple of (processed PIL Image, metadata)
    """
    image.load()
