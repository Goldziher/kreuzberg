...
def test_is_cuda_available_true() -> None:
    """Test CUDA availability detection when CUDA is available."""
    mock_torch = Mock()
...
def test_is_cuda_available_false() -> None:
    """Test CUDA availability detection when CUDA is not available."""
    mock_torch = Mock()
...
def test_is_cuda_available_no_torch() -> None:
    """Test CUDA availability detection when torch is not available."""
