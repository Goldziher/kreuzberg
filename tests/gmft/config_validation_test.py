...
def test_config_hashability() -> None:
    config1 = VisionTablesConfig(detection_threshold=0.7)
    config2 = VisionTablesConfig(detection_threshold=0.7)
    config3 = VisionTablesConfig(detection_threshold=0.8)
...
def test_model_variant_configurations() -> None:
    ...
    config_fin = VisionTablesConfig(structure_model="microsoft/table-transformer-structure-recognition-v1.1-fin")
...
def test_cache_directory_configuration() -> None:
    ...
    config = VisionTablesConfig(model_cache_dir="/custom/cache/path")
