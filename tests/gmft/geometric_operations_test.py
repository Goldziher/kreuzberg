...
def test_rect_invalid_bbox() -> None:
    rect = Rect((50.0, 100.0, 10.0, 20.0))
    assert rect.width == -40.0
    assert rect.height == -80.0
    assert rect.area == 3200.0


def test_intersect_with_invalid_bbox() -> None:
    bbox1 = (50.0, 50.0, 10.0, 10.0)
    bbox2 = (10.0, 10.0, 50.0, 50.0)
