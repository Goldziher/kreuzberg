...
describe("Async PostProcessor Support", () => {
	...
	describe("Async Processor Execution", () => {
		...
		it("should execute sync processor normally", () => {
	...
	describe("Clean API - Metadata Handling", () => {
		it("should automatically parse metadata from string to object", () => {
		...
		it("should preserve existing metadata when adding new fields", () => {
	...
	describe("Case Conversion", () => {
		it("should provide camelCase properties to processors", () => {
		...
		it("should handle all ExtractionResult properties correctly", () => {
	...
	describe("Integration with extractBytesSync", () => {
		it("should work with sync extraction even for async processors", () => {
			// Sync extraction should work with async processors
