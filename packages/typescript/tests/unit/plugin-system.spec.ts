...
describe("Plugin System - PostProcessors", () => {
	...
	describe("Registration and Execution", () => {
		it("should register and execute early-stage processor", () => {
		...
		it("should register and execute middle-stage processor", () => {
		...
		it("should register and execute late-stage processor", () => {
	...
	describe("Execution Order", () => {
		it("should execute multiple processors in stage order", () => {
		...
		it("should execute multiple processors in same stage", () => {
	...
	describe("Metadata Modification", () => {
		it("should add metadata without overwriting existing", () => {
		...
		it("should accumulate metadata across processor chain", () => {
	...
	describe("Processor Lifecycle", () => {
		...
		it("should handle multiple extraction calls with same processor", () => {
			const processor = new InitializableProcessor();
			registerPostProcessor(processor);
	...
	describe("Error Handling", () => {
		...
		it("should capture internal processor errors", () => {
	...
	describe("Processor Configuration", () => {
		it("should support PostProcessorConfig.enabled", () => {
			const processor = new WordCountProcessor();
			registerPostProcessor(processor);
		...
		it("should support PostProcessorConfig whitelist", () => {
			const proc1 = new WordCountProcessor();
			const proc2 = new SentenceCountProcessor();
		...
		it("should support PostProcessorConfig blacklist", () => {
			const proc1 = new WordCountProcessor();
			const proc2 = new SentenceCountProcessor();
	...
	describe("Edge Cases", () => {
		...
		it("should handle processor with duplicate names", () => {
		...
		it("should handle processor without optional methods", () => {
	...
	describe("Realistic Use Cases", () => {
		it("should support realistic text analysis pipeline", () => {
			const wordProc = new WordCountProcessor();
			const sentenceProc = new SentenceCountProcessor();
...
Deep learning uses neural networks with multiple layers.`;
	...
	describe("Registry Management", () => {
		it("should unregister processor by name", () => {
			const processor = new WordCountProcessor();
			registerPostProcessor(processor);
