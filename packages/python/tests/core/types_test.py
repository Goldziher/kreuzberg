...
from kreuzberg import ExtractedImage
...
def test_entity_extraction_config_post_init_conversions() -> None:
    ...
    from kreuzberg import EntityExtractionConfig
...
def test_extraction_config_get_config_dict() -> None:
    ...
    from kreuzberg import EasyOCRConfig, ExtractionConfig, PaddleOCRConfig, TesseractConfig
...
def test_extraction_result_table_export_methods() -> None:
    ...
    from kreuzberg import ExtractionResult, TableData
...
def test_json_extraction_config_post_init_validation() -> None:
    from kreuzberg import JSONExtractionConfig
...
def test_extraction_config_nested_object_to_dict() -> None:
    ...
    from kreuzberg import ExtractionConfig, HTMLToMarkdownConfig, LanguageDetectionConfig, TesseractConfig
...
def test_normalize_metadata_function() -> None:
    from kreuzberg import normalize_metadata
...
def test_extraction_config_nested_to_dict_calls() -> None:
    ...
    from kreuzberg import ExtractionConfig, HTMLToMarkdownConfig, TesseractConfig
...
def test_extraction_result_to_dict_with_nested_config() -> None:
    from kreuzberg import ExtractionResult, PSMMode, TesseractConfig
